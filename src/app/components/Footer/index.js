...
const Footer = () => {
  ...
  return (
    <Fragment>
      ...
      <NestedContainer maxWidth="lg" className={classes.innerContainer}>
        {/* input box */}
        <Box
          order={{ sm: 1 }}
          display="flex"
        ...
        <Box display={{ sm: 'flex' }} justifyContent={{ sm: 'space-between' }}>
          ...
          >
            ...
            <Box>
              <Link to="careers" label="Careers" />
              <Link to="community" label="Community" />
          ...
          >
            ...
            {/* end of social links */}
            {/* logo */}
            <Box color="white" mt={{ xs: '40px', md: 0 }} textAlign="center">
